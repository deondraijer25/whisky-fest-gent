...
export const TICKETS_GENT: TicketItem[] = [
  ...
  },
  {
    ...
    isSoldOut: false,
    isLowStock: false,
    description: "Ontdek de unieke koperen koelring-distillatietechniek en verfijnde Highland single malts van Fettercairn.",
    ambassadorName: "Fettercairn Brand Ambassador",
    ambassadorTitle: "Highland Single Malt Specialist",
    ambassadorBio: "Vertegenwoordigt het baanbrekende Schotse erfgoed van Fettercairn sinds 1824.",
    tastingLineup: ["Fettercairn 12 Years Old", "Fettercairn 16 Years Old", "Fettercairn 18 Years Old Scottish Oak", "Fettercairn Warehouse 2 Special Release"]
  },
  {
